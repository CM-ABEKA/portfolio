...
function checkViewportWidth() {
  if (window.innerWidth < 774) {
    ...
    document.body.innerHTML = '<div id="mask_dom"><h1>Screen Too Small</h1><p>Please view this page on a larger screen.</p><a href="chris_portfolio.jpeg" download>Download Pdf</a></div>';
  } else {
